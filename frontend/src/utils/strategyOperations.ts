...
type RadarPlanSnapshots = { strategy_type?: string | null; radar_tier?: number | null; radar_profile?: RadarProfile | null; radar_cycle_id?: string | null; radar_cycle_capital?: string | null };
